...
import { InitialState, NavigationContainer, NavigationState, useNavigation } from '@react-navigation/native';
...
function chargingStationDetailsTabsNavigator() {
  return (
    ...
    inactiveColor={commonColor.topTabBarTextColor} style={barStyle}  labeled={true} backBehavior='none'>
...
function chargingStationConnectorDetailsTabsNavigator() {
  return (
...
function transactionDetailsTabsNavigator() {
  return (
...
function createSitesNavigator() {
  return(
    <SitesStack.Navigator initialRouteName='Sites' headerMode='none'>
      ...
      <SitesStack.Screen name='ChargingStationDetailsTabs' component={chargingStationDetailsTabsNavigator}/>
      <SitesStack.Screen name='ChargingStationConnectorDetailsTabs' component={chargingStationConnectorDetailsTabsNavigator}/>
      <SitesStack.Screen name='TransactionDetailsTabs' component={transactionDetailsTabsNavigator}/>
...
function createChargingStationsNavigator() {
  return (
    <ChargingStationsStack.Navigator initialRouteName='ChargingStations' headerMode='none'>
      ...
      <ChargingStationsStack.Screen name='ChargingStationDetailsTabs' component={chargingStationDetailsTabsNavigator}/>
      <ChargingStationsStack.Screen name='ChargingStationConnectorDetailsTabs' component={chargingStationConnectorDetailsTabsNavigator}/>
      <ChargingStationsStack.Screen name='TransactionDetailsTabs' component={transactionDetailsTabsNavigator}/>
...
function createTransactionHistoryNavigator() {
  return (
    <TransactionHistoryStack.Navigator initialRouteName='TransactionsHistory' headerMode='none'>
      ...
      <TransactionHistoryStack.Screen name='TransactionDetailsTabs' component={transactionDetailsTabsNavigator}/>
...
function createTransactionInProgressNavigator() {
  return (
    <TransactionInProgressStack.Navigator initialRouteName='TransactionsInProgress' headerMode='none'>
      ...
      <TransactionInProgressStack.Screen name='ChargingStationDetailsTabs' component={chargingStationDetailsTabsNavigator}/>
      <TransactionInProgressStack.Screen name='ChargingStationConnectorDetailsTabs' component={chargingStationConnectorDetailsTabsNavigator}/>
...
function createRootNavigator(initialState: InitialState) {
  return (
    <NavigationContainer ref={(navigatorRef) => { this.navigator = navigatorRef }}
        onStateChange={persistNavigationState} initialState={initialState}>
      <rootStack.Navigator initialRouteName='AuthNavigator'>
...
export default class App extends React.Component<Props, State> {
  ...
  private navigator = useNavigation();
  private location: LocationManager;
  private theme: ThemeManager;
  private navigationState: InitialState;
  ...
  public async componentDidMount() {
    ...
    this.navigationState = await SecuredStorage.getNavigationState();
  ...
  public render() {
    return (
      <RootSiblingParent>
        ...
        {createRootNavigator(this.navigationState)}
      </RootSiblingParent>
    );
  }
