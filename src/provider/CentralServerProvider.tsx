...
import { HttpTransactionRequest } from '../types/requests/HTTPTransactionRequest';
...
export default class CentralServerProvider {
  ...
  public async getTransaction(id: number, extraParams: HttpTransactionRequest = {}): Promise<Transaction> {
